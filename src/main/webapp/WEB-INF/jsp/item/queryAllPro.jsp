    ...
    <script>
        layui.use(['table','layer', 'jquery'], function(){
            ...
            table.render({
                elem: '#test',
                toolbar:'#toolbarDemo',
                url: '${pageContext.request.contextPath }/pro/proQueryAll', //数据接口
                method:"post",
                id:'testReload',
                limit:'5',
                ...
                cols: [[ //表头
                    ...
                    {field: 'piName', title: '名称',align:'center'},
                    {field: 'piDepartment', title: '单位/部门/公司',align:'center'},
                    {field: 'piCreateId', title: '创建者ID',align:'center'},
                    {field: 'piCreateDt', title: '创建时间',align:'center'},
                    {field: 'piPlanStartDt', title: '计划开始',align:'center'},
                    {field: 'piPlanEndDt', title: '计划结束',align:'center'},
                    {field: 'piRealStartDt', title: '实际开始',align:'center'},
                    {field: 'piRealEndDt', title: '实际结束',align:'center'},
                    {field: 'piState', title: '状态',align:'center'},
            ...
            active = {
                ...
                batchDeletion:function() {
                    ...
                    layer.confirm('确认要删除  '+delArray+' 吗？', function (index) {
                        $.ajax({
                            type: 'POST',
                            url: '${pageContext.request.contextPath }/pro/deletePro',
...
/*                    //把数组中的所有元素放入一个字符串ids,使用,作为分隔符。
                ...
                add: function(){
                    ...
                    layer.open({
                        ...
                        ,content: '${pageContext.request.contextPath }/pro/toaddPro'
                        /*,end:function () {
                            location.reload();
                        }*/
        ...
        function delHospital(id){
            //alert(id);
            $.post("${pageContext.request.contextPath }/pro/delPro",{id:id},function(result){
        ...
        function  updateStu(id) {
            layer.open({
                ...
                ,btnAlign: 'c'
                ,moveType: 1 //拖拽模式，0或者1
                ,content: '${pageContext.request.contextPath }/pro/findPro?id='+id
                ,end:function () {
                    location.reload();
                }
            })
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-input-block" style="width: 200px;float: left;margin-left:0px">
        <input id="piName" style="width: 200px" type="text" name="piName" required lay-verify="required" placeholder="请输入项目名称" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-warm layui-btn-radius" lay-event="search">搜索</button>

        <button class="layui-btn layui-btn layui-btn-radius" lay-event="add">添加项目</button>
